...
// *************************************************************************
// *				WinMain:- Terry Mo and Hazel 2025   		  		   *
// *************************************************************************
...
// *************************************************************************
// *			MyRegisterClass:- Terry Mo and Hazel 2025   	  	 	   *
// *************************************************************************
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    WNDCLASSEX wcex;
    ...
    wcex.hbrBackground  = (HBRUSH)(CreateSolidBrush(RGB(213, 222, 242)));
    wcex.lpszMenuName   = MAKEINTRESOURCE(IDC_ROOMBUILDER1);
...
// *************************************************************************
// *			InitInstance:- Terry Mo and Hazel 2025      			   *
// *************************************************************************
...
// *************************************************************************
// *				WndProc:- Terry Mo and Hazel 2025   	  			   *
// *************************************************************************
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
            ...
            case ID_DEBUG_CLAMPFPS:
            {
                ...
                {
                    App->CL_Ogre3D->flag_Clamp_FPS = false;
                    App->CL_Ogre->FPSLock = 0;
                }
                else
                {
                    App->CL_Ogre3D->flag_Clamp_FPS = true;
                    App->CL_Ogre->FPSLock = 16666;;
                }

                return true;
            }

            case ID_DEBUG_SANDBOXTEST:
            {
            ...
            case ID_APPDEBUG_DIRECTORIESANDNAMES:
            {
                App->CL_Dialogs->Start_General_ListBox(Enums::ListBox_Directories);

                return true;
            }

            case ID_APPDEBUG_MESHDATA:
            {
           ...
           // ID_IMPORT_AUTODESK3DS
            ...
            case ID_FILE_CLEAR32874:
            {
                App->CL_Dialogs->YesNo("Clear Model", "Are you sure");
            ...
            case ID_VIEW_HELP:
            {
                App->Open_HTML((LPSTR)"Help\\Menu_Views.html");
                return true;
            }
            ...
            // --------------------------------------------- Help
            case ID_HELP_MOUSEANDKEYS:
            {
                App->Open_HTML((LPSTR)"Help\\MouseAndKeys.html");
                break;
            }
			...
			{
                App->Open_HTML((LPSTR)"Help\\Getting_Started.html");
				break;
			}
            ...
            case IDM_EXIT:
            {
                ...
                {
                    App->CL_Dialogs->YesNo("Close Cheryl Modeller","Are you sure");
                ...
                if (App->CL_Ogre->Listener_3D->flag_StopOgre == 0)
                {
                    App->CL_Ogre->Listener_3D->flag_StopOgre = 1;
                }
    ...
    case WM_SIZE:
    {
        ...
        {
            MoveWindow(Views_Com->Main_View_Dlg_Hwnd, 0, 75, rcl.right, rcl.bottom - 75, TRUE);
            Views_Com->Init_Views(Enums::Selected_Map_View_None);
...
// *************************************************************************
// *			ViewerMain_Proc:- Terry Mo and Hazel 2025   			   *
// *************************************************************************
LRESULT CALLBACK ViewerMain_Proc(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
...
// *************************************************************************
// *				StartOgre:- Terry Mo and Hazel 2025     		 	   *
// *************************************************************************
void StartOgre()
{
...
// *************************************************************************
// *				Close_App:- Terry Mo and Hazel 2025     	  		   *
// *************************************************************************
void Close_App()
{
...
INT_PTR CALLBACK About(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
    {
        ...
        sprintf(buf, "%s %s", "Libraries", App->CL_Libs->GetVersion());
