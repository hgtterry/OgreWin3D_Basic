...
// *								Vector3_Add						 	   *
// *************************************************************************
void CL64_Lib_Maths::Vector3_Add(const T_Vec3* V1, const T_Vec3* V2, T_Vec3* V1PlusV2)
{
...
// *						Vector3_Subtract							   *
// *************************************************************************
void CL64_Lib_Maths::Vector3_Subtract(const T_Vec3* V1, const T_Vec3* V2, T_Vec3* V1MinusV2)
{
	if (V1MinusV2 == NULL)
	{
		return;
...
// *							Vector3_Scale						 	   *
// *************************************************************************
void CL64_Lib_Maths::Vector3_Scale(const T_Vec3* VSrc, float Scale, T_Vec3* VDst)
{
	VDst->x = VSrc->x * Scale;
	VDst->y = VSrc->y * Scale;
	VDst->z = VSrc->z * Scale;
...
// *							Vector3_Normalize					 	   *
// *************************************************************************
float CL64_Lib_Maths::Vector3_Normalize(T_Vec3* V1)
{
	float OneOverDist;
	float Dist;
...
// *						Vector3_DotProduct						 	   *
// *************************************************************************
float CL64_Lib_Maths::Vector3_DotProduct(const T_Vec3* V1, const T_Vec3* V2)
{
...
// *							Vector3_Copy						 	   *
// *************************************************************************
void CL64_Lib_Maths::Vector3_Copy(const T_Vec3* VSrc, T_Vec3* VDst)
{
	*VDst = *VSrc;
}
...
// *							Vector3_Clear						 	   *
// *************************************************************************
void CL64_Lib_Maths::Vector3_Clear(T_Vec3* V)
{
	V->x = 0.0f;
	V->y = 0.0f;
	V->z = 0.0f;
...
// *************************************************************************
void CL64_Lib_Maths::Vector3_CrossProduct(const T_Vec3* V1, const T_Vec3* V2, T_Vec3* VResult)
{
	T_Vec3 Result;
...
// *							Vector3_Compare							   *
// *************************************************************************
signed int CL64_Lib_Maths::Vector3_Compare(const T_Vec3* V1, const T_Vec3* V2, float Tolerance)
{
...
// *************************************************************************
int CL64_Lib_Maths::Ogre_Vector3_Compare(Ogre::Vector3* V1, Ogre::Vector3* V2, float Tolerance)
{
...
// *************************************************************************
void CL64_Lib_Maths::Vector3_Inverse(T_Vec3* V)
{
	V->x = -V->x;
	V->y = -V->y;
	V->z = -V->z;
...
// *************************************************************************
void CL64_Lib_Maths::Vector3_AddScaled(const T_Vec3* V1, const T_Vec3* V2, float Scale, T_Vec3* V1PlusV2Scaled)
{
...
// *************************************************************************
void CL64_Lib_Maths::Vector3_MA(T_Vec3* V1, float Scale, const T_Vec3* V2, T_Vec3* V1PlusV2Scaled)
{
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_SetIdentity(Matrix3d* M)
{
	assert(M != NULL);
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_RotateX(Matrix3d* M, float RadianAngle)
{
	Matrix3d R;
...
// *			XForm3d_RotateX:- Terry and Hazel Flanigan 2024			   *
// *************************************************************************
void CL64_Lib_Maths::XForm3d_SetXRotation(Matrix3d* M, float RadianAngle)
{
	float Cos, Sin;
	assert(M != NULL);
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_SetYRotation(Matrix3d* M, float RadianAngle)
{
	float Cos, Sin;
	assert(M != NULL);
	assert(RadianAngle * RadianAngle >= 0.0f);
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_SetZRotation(Matrix3d* M, float RadianAngle)
{
	float Cos, Sin;
	assert(M != NULL);
	assert(RadianAngle * RadianAngle >= 0.0f);
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_Rotate(const Matrix3d* M, const T_Vec3* V, T_Vec3* Result)
{
	T_Vec3 VL;
...
// *						geXForm3d_Transform							   *
// *************************************************************************
void CL64_Lib_Maths::XForm3d_Transform(const Matrix3d* M, const T_Vec3* V, T_Vec3* Result)
{
	T_Vec3 VL;
...
// *							XForm3d_Multiply						   *
// *************************************************************************
void CL64_Lib_Maths::XForm3d_Multiply(const Matrix3d* M1, const Matrix3d* M2, Matrix3d* MProduct)
{
	Matrix3d M1L;
	Matrix3d M2L;
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_GetEulerAngles(const Matrix3d* M, T_Vec3* Angles)
{
...
// *************************************************************************
void CL64_Lib_Maths::XForm3d_SetEulerAngles(Matrix3d* M, const T_Vec3* Angles)
{
	Matrix3d XM, YM, ZM;
...
// *************************************************************************
void CL64_Lib_Maths::Quaternion_SetFromAxisAngle(Ogre::Quaternion* Q, const T_Vec3* Axis, float Theta)
{
	float sinTheta;
...
// *************************************************************************
void CL64_Lib_Maths::Quaternion_ToMatrix(const Ogre::Quaternion* Q, Matrix3d* M)
{
...
// *************************************************************************
void CL64_Lib_Maths::Quaternion_From_Matrix(const Matrix3d* M, Ogre::Quaternion* Q)
{
	float trace, s;
...
// *************************************************************************
int CL64_Lib_Maths::Ogre_Quaternion_Compare(Ogre::Quaternion* Q1, Ogre::Quaternion* Q2, float Tolerance)
{
